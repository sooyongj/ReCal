...
from ReCal.model.CIFARLeNet5 import LeNet5
...
def run(args):
  ...
  if args.model_name == 'lenet5':
    model = LeNet5(n_labels=10 if is_ten else 100)
  else:
    raise ValueError('Not supported model: {}'.format(args.model_name))
  ...
  base_filename = ('cifar10_' if is_ten else 'cifar100_') + args.model_name
